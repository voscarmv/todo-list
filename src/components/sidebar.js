...
const Sidebar = (projects) => {
  // projects = array of Project objects to generate list
  const sidebar = nestElements(
    ...
    listElements(
      ...
      nestElements(
        ...
        newElement('a', 'nav-link active', 'Project #1', null, ['href', '#'])
      ),
      nestElements(
        newElement('li', 'nav-item'),
        newElement('a', 'nav-link active', 'Project #2', null, ['href', '#'])
      ),
      nestElements(
        newElement('li', 'nav-item'),
        newElement('a', 'nav-link active', 'Project #3', null, ['href', '#'])
      ),
    ),
  );
  return sidebar;
